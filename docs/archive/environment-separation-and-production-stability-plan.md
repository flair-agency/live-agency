...
- [Task orchestration policy](../governance/development-policy.md): use bounded outcomes, explicit authority, and focused verification. This plan does not dispatch workers or alter model settings.
