...
- Governing policy: Cross-boundary classes C/D/E under the [permanent task orchestration policy](../governance/development-policy.md). Changes to operational routes also require the individual class F gates.
...
[permanent policy](../governance/development-policy.md#6-model-and-reasoning-routing).
