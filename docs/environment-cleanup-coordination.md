...
[npm lifecycle](npm-runtime-lifecycle-design.md),
[reorganization](repository-reorganization-plan.md), and
[task policy](task-orchestration-policy.md). Later owner decisions below supersede
...
user choices in [distribution decision](npm-runtime-distribution-decision.md):
