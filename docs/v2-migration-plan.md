...
12. Every Provider using Lark OpenAPI must support explicit User/Tenant
    ...
    [selection design](../provider-runtime/docs/v2-lark-api-principal-selection.md).
...
- **Implemented and locally verified, 2026-09-06:** [Local correction evidence](../provider-runtime/docs/backup-gate-local-correction-checkpoint.md). Local corrections remove blanket
...
The [permanent orchestration policy](task-orchestration-policy.md) owns change
...
Use the [permanent model policy](task-orchestration-policy.md#6-model-and-reasoning-routing):
...
[remaining-work grouping](v2-work-package-consolidation.md) to combine one logical
...
[consolidation map](v2-work-package-consolidation.md) to remaining work and the
[worker brief](v2-task-execution-instructions.md#worker-brief-and-dispatch) at
...
[Checkpoint and verification](../provider-runtime/docs/v2-m2u-transport-checkpoint.md).
...
See [exact scope and remaining gates](../provider-runtime/docs/v2-m2u-4a-gift-projection-checkpoint.md).
...
[launcher follow-up](../provider-runtime/docs/v2-m2u-4a-gift-projection-checkpoint.md#composition-launcher-follow-up).
...
See the [composition checkpoint](../provider-runtime/docs/v2-m2u-4b-attachment-acquisition.md#private-composition-launcher-follow-up).
...
[evidence handoff decision](../provider-runtime/docs/v2-m2u-2b-attachment-authorization-checkpoint.md#evidence-handoff-decision)
...
checks passed. See the [implementation checkpoint](../provider-runtime/docs/v2-m2u-2b-attachment-authorization-checkpoint.md#core-lifecycle-implementation).
...
[Provider checkpoint](../provider-runtime/docs/v2-m2u-2b-attachment-authorization-checkpoint.md#provider-factorychannel-implementation).
Core 102/102 is inherited, not rerun. No real producer/verifier or live authority
was supplied. The owner review [decision packet](../provider-runtime/docs/v2-m2u-2b-attachment-evidence-owner-review.md) is now prepared locally.
...
See the [local conformance checkpoint](../provider-runtime/docs/v2-m2u-2b-attachment-cli-conformance.md).

This work is required for v2 cutover, including cross-domain Lark consumers.
The [selection design](../provider-runtime/docs/v2-lark-api-principal-selection.md) owns the detailed
...
The reviewed [LIVE Agency Skill Naming Policy](skill-naming-policy.md) and
the draft [Skill Naming and Migration Plan](v2-skill-naming-and-migration-plan.md)
...
Evidence: the [2026-09-06 roundtrip result](../provider-runtime/docs/backup-roundtrip-result.md#measured-comparison)
...
features is not proven. See the result's [detailed unverified scope](../provider-runtime/docs/backup-roundtrip-result.md#local-evidence-and-scope).
...
[checkpoint](../provider-runtime/docs/backup-capability-contract-checkpoint.md). Added pure normalization,
