...
> by [the orchestration policy](task-orchestration-policy.md). No historical
...
- Earlier M2U checkpoint (not the current next-package instruction): M2U requires explicit User/Tenant profile selection
  ...
  [selection design](../provider-runtime/docs/v2-lark-api-principal-selection.md), migration plan, PERT
...
- The reviewed [LIVE Agency Skill Naming Policy](skill-naming-policy.md) and
  its [companion migration plan](v2-skill-naming-and-migration-plan.md) define
...
[selection design](../provider-runtime/docs/v2-lark-api-principal-selection.md) specifies the existing
...
4. **M2U all-Lark OpenAPI User/Tenant selection — M2U-1 implemented 2026-09-05; transport and rollout pending**
   - Follow the [selection design](../provider-runtime/docs/v2-lark-api-principal-selection.md).
     M2U-1 inventory/profile contract and rejection tests are implemented; see
     [the checkpoint](../provider-runtime/docs/v2-m2u-inventory-and-contract.md). M2U-2 shared transport
