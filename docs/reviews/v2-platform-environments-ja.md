...
| 次の作業 | 人の担当 | 期限 | 概要 | 完了条件 | 参照 |
| --- | --- | --- | --- | --- | --- |
| Profile履歴読取の対象範囲・取得量の修正 | TBD | TBD | attachmentの所属確認と既存業務判断を保持し、全履歴反復読取の接続を見直す | 修正範囲の検証と限定した実Work履歴読取を確認してからM3へ進む | [Provider #4](https://github.com/flair-agency/live-agency-provider-lark-base/issues/4)、[#31](https://github.com/flair-agency/live-agency/issues/31) |
