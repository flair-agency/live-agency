...
| Registration | TBD | TBD | Review the remaining write connection under the same responsibility boundaries, then execute and read back after approval of a concrete plan | Read success grants no registration authority. Preserve existing duplicate-registration prevention and reconciliation of uncertain outcomes |
